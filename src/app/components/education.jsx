...
const EducationExperience = () => {
  ...
  const experienceData = [
    ...
    },
    {
      ...
      duration: '2026 - Present',
      description: 'Developed a modern full-stack website using Next.js and Node.js, focusing on responsive UI, dynamic features, and efficient backend integration.',
